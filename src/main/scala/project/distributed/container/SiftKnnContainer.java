...
public class SiftKnnContainer implements Serializable {
    ...
    private SiftDescriptorContainer queryPoint;
    private int k;
    private int n;
    private int maxDistance;
    private int maxIndex;
    private knnPair[] theKNN;
    ...
    //@Override
    private SiftDescriptorContainer getQueryPoint() {
        return queryPoint;
    }
    ...
    //@Override
    boolean add(SiftDescriptorContainer point, int index) {
        int distance = Integer.MAX_VALUE;
    ...
    //@Override
    private boolean addNoDuplicateIDs(int id, int distance) {
    ...
    private synchronized boolean add(int id, int distance) {
    ...
    private int DistanceWithHalt(SiftDescriptorContainer point) {
        int dist = 0;
        int a;
    ...
    public int DistanceWithHaltUnrolled(SiftDescriptorContainer point) {
